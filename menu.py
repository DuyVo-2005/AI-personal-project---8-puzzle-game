...
class StartFrame(tk.Frame):
    def __init__(self, parent):
        ...
        tk.Button(self, text="Fully observered environment", font=("Times New Roman", 13), command=lambda: show_fully_observered_environment_screen(), width= 30).pack(pady=5)
        tk.Button(self, text="Sensorless problem", font=("Times New Roman", 13), command=lambda: show_sensorless_problem_screen(), width= 30).pack(pady=5)
        tk.Button(self, text="Constrain satisfaction problem", font=("Times New Roman", 13), command=lambda: show_constrain_satisfaction_problem(), width= 30).pack(pady=5)
...
class ComplexEnviromentFrame(tk.Frame):
    def __init__(self, parent):
        ...
        tk.Button(self, text="AND OR graph search", font=("Times New Roman", 13), command=lambda: show_fully_observered_environment_screen(), width= 30).pack(pady=5)
...
def show_fully_observered_environment_screen():
